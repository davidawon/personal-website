    ...
    <section id="contact" className="py-32 px-6">
      <div ref={ref} className="max-w-4xl mx-auto text-center">
        ...
        >
          {links.map((link, i) => (
            <motion.a
              ...
              className="group flex items-center gap-4 p-5 rounded-2xl bg-card border border-card-border card-glow hover:border-accent/20 transition-all duration-300 text-left"
            >
        ...
        <motion.a
          ...
          className="inline-flex items-center gap-2 px-8 py-4 bg-accent text-white font-medium rounded-full hover:shadow-[0_0_30px_rgba(99,102,241,0.3)] transition-all"
        >
          Say Hello
